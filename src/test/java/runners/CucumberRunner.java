...
@CucumberOptions (
        ...
        tags = "regression", // all scenarios tagged with @temp
...
//        features = "/Users/Dave/IdeaProjects/duobank-cucumber-bdd-framework-dilshod/src/test/resources",
//        features = "/Users/Dave/IdeaProjects/duobank-cucumber-bdd-framework-dilshod/src/test/resources/features",
//
        glue = "stepDefinitions", // path where step definitions are located
        publish = false, // generates a cloud based html temporary report with a shareable link directly on the console
        plugin = {
